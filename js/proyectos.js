$(document).ready(function () {
    if ($('.countInm').length > 0) {
        ...
        $.ajax({
            url: PROTOCOLO+'://simicrm.app/models/proyectos.php?data=2',
            dataType: 'json',
            method: "POST",
            data: {
                codInmu: codInmu,
            ...
            success: function (data) {
                ...
                carousel_items +=
                    '<div class="carousel-item active">\
                     <a data-fancybox="gallery" href="'+ data[0].fotos[0].foto + '" class="">\
                        <div class="hover-box">\
                            <img src="'+ data[0].fotos[0].foto + '" class="w-100" alt="...">\
                            <div class="hover row w-100 justify-content-center align-items-center">\
                ...
                for (var i = 1; i < data[0].fotos.length; i++) {
                    carousel_items += '<div class="carousel-item ">\
                        <a data-fancybox="gallery" href="'+ data[0].fotos[i].foto + '" class="">\
                        <div class="hover-box">\
                            <img src="'+ data[0].fotos[i].foto + '" class="w-100" alt="...">\
                            <div class="hover"></div>\
                        </div>\
                        </a>\
                  </div>';
                ...
                $('#listOtras .list').html(htmlOtras);
                    ...
                    var map = L.map('map').setView([data[0].latitud, data[0].longitud], 15);
                    ...
                    L.marker([data[0].latitud, data[0].longitud]).addTo(map)
                        ...
                        $('.cambio1').removeClass('show');
                        $('.cambio1').removeClass('active');

                        $('.cambio2').addClass('show');
                        $('.cambio2').addClass('active');

                        $('.cambio-3').removeClass('active');
                        $('.cambio-4').addClass('active');
